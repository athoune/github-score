...
MESSAGES: dict[str, dict[str, str]] = {
    "fr": {
        ...
        "cmp_table_stars": "Stars",
        "cmp_table_license": "Licence",
        "cmp_table_lang": "Lang.",
        ...
        "cmp_rank_note": "lignes triées par verdict, puis téléchargements, puis bus factor",
        ...
        "fact_fork_pr": "#{number} ({state}) : {title}",
        ...
        "tui_fork_prs": "PRs depuis ce fork : {prs}",
    ...
    "en": {
        ...
        "cmp_table_verdict": "Verdict",
        "cmp_rank_note": "rows sorted by verdict, then downloads, then bus factor",
        ...
        "tui_fork_prs": "PRs from this fork: {prs}",
